...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{UML dinamico_ diagrama de secuencia_main.png}
    \caption{UML Dinámico: Diagrama de secuencia del main.}
    \label{fig:seq_main}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{UML dinamico_ diagrama de secuencia_combate_view.png}
    \caption{UML Dinámico: Diagrama de secuencia de combate_view}
    \label{fig:seq_combate_view}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{UML dinamico_ diagrama de secuencia_combate_controller.png}
    \caption{UML Dinámico: Diagrama de secuencia de combate_controller}
    \label{fig:seq_combate_controller}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{UML dinamico_ diagrama de secuencia_seleccion_page.png}
    \caption{UML Dinámico: Diagrama de secuencia de seleccion_page}
    \label{fig:seq_seleccion_page}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{UML dinamico_ diagrama de secuencia_batalla_page.png}
    \caption{UML Dinámico: Diagrama de secuencia de batalla_page}
    \label{fig:seq_batalla_page}
\end{figure}

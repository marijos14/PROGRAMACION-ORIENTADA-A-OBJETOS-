...
class CombateController {
  ...
  void iniciarCombate(
    ...
    print('Tengo que ser siempre el mejor, mejor que nadie maaaaás...');
...
void main() {
  ...
  final charmander = PokemonFuego(nombre: 'Charizard', nivel: 50);
  final bulbasaur = PokemonHierba(nombre: 'Venusaur', nivel: 50);
